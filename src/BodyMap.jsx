...
// The silhouette center is at x≈103, head top at y≈0, feet at y≈206
const ZONES_FRONT = [
  // Head & neck
  { id: "head",       label: "Tête",              cx: 103,  cy: 9,   rx: 11, ry: 10 },
  { id: "neck",       label: "Cou",               cx: 103,  cy: 22,  rx: 5,  ry: 5  },
  // Chest & belly
  { id: "chest",      label: "Poitrine",          cx: 103,  cy: 47,  rx: 13, ry: 9  },
  { id: "belly",      label: "Ventre",            cx: 103,  cy: 65,  rx: 12, ry: 8  },
  // Arms
  { id: "arm_r",      label: "Bras droit",        cx: 69,   cy: 55,  rx: 7,  ry: 12 },
  { id: "arm_l",      label: "Bras gauche",       cx: 137,  cy: 55,  rx: 7,  ry: 12 },
  { id: "elbow_r",    label: "Coude droit",       cx: 64,   cy: 73,  rx: 6,  ry: 5  },
  { id: "elbow_l",    label: "Coude gauche",      cx: 142,  cy: 73,  rx: 6,  ry: 5  },
  { id: "forarm_r",   label: "Avant-bras droit",  cx: 60,   cy: 88,  rx: 6,  ry: 9  },
  { id: "forarm_l",   label: "Avant-bras gauche", cx: 146,  cy: 88,  rx: 6,  ry: 9  },
  { id: "wrist_r",    label: "Poignet droit",     cx: 57,   cy: 102, rx: 5,  ry: 4  },
  { id: "wrist_l",    label: "Poignet gauche",    cx: 149,  cy: 102, rx: 5,  ry: 4  },
  { id: "hand_r",     label: "Main droite",       cx: 55,   cy: 113, rx: 6,  ry: 7  },
  { id: "hand_l",     label: "Main gauche",       cx: 151,  cy: 113, rx: 6,  ry: 7  },
  // Legs
  { id: "hip_r",      label: "Hanche droite",     cx: 91,   cy: 116, rx: 9,  ry: 14 },
  { id: "hip_l",      label: "Hanche gauche",     cx: 115,  cy: 116, rx: 9,  ry: 14 },
  { id: "knee_r",     label: "Genou droit",       cx: 91,   cy: 138, rx: 8,  ry: 6  },
  { id: "knee_l",     label: "Genou gauche",      cx: 115,  cy: 138, rx: 8,  ry: 6  },
  { id: "shin_r",     label: "Tibia droit",       cx: 90,   cy: 158, rx: 7,  ry: 11 },
  { id: "shin_l",     label: "Tibia gauche",      cx: 116,  cy: 158, rx: 7,  ry: 11 },
  { id: "ankle_r",    label: "Cheville droite",   cx: 89,   cy: 176, rx: 6,  ry: 4  },
  { id: "ankle_l",    label: "Cheville gauche",   cx: 117,  cy: 176, rx: 6,  ry: 4  },
  { id: "foot_r",     label: "Pied droit",        cx: 88,   cy: 189, rx: 8,  ry: 5  },
  { id: "foot_l",     label: "Pied gauche",       cx: 118,  cy: 189, rx: 8,  ry: 5  },
];

const ZONES_BACK = [
  { id: "head_b",     label: "Tête",              cx: 103,  cy: 9,   rx: 11, ry: 10 },
  { id: "neck_b",     label: "Nuque",             cx: 103,  cy: 22,  rx: 5,  ry: 5  },
  { id: "upback",     label: "Dos haut",          cx: 103,  cy: 47,  rx: 13, ry: 9  },
  { id: "lowback",    label: "Dos bas",           cx: 103,  cy: 65,  rx: 12, ry: 8  },
  { id: "arm_r_b",    label: "Bras droit",        cx: 69,   cy: 55,  rx: 7,  ry: 12 },
  { id: "arm_l_b",    label: "Bras gauche",       cx: 137,  cy: 55,  rx: 7,  ry: 12 },
  { id: "elbow_r_b",  label: "Coude droit",       cx: 64,   cy: 73,  rx: 6,  ry: 5  },
  { id: "elbow_l_b",  label: "Coude gauche",      cx: 142,  cy: 73,  rx: 6,  ry: 5  },
  { id: "forarm_r_b", label: "Avant-bras droit",  cx: 60,   cy: 88,  rx: 6,  ry: 9  },
  { id: "forarm_l_b", label: "Avant-bras gauche", cx: 146,  cy: 88,  rx: 6,  ry: 9  },
  { id: "wrist_r_b",  label: "Poignet droit",     cx: 57,   cy: 102, rx: 5,  ry: 4  },
  { id: "wrist_l_b",  label: "Poignet gauche",    cx: 149,  cy: 102, rx: 5,  ry: 4  },
  { id: "buttocks",   label: "Fesses",            cx: 103,  cy: 83,  rx: 14, ry: 7  },
  { id: "hip_r_b",    label: "Hanche droite",     cx: 91,   cy: 116, rx: 9,  ry: 14 },
  { id: "hip_l_b",    label: "Hanche gauche",     cx: 115,  cy: 116, rx: 9,  ry: 14 },
  { id: "knee_r_b",   label: "Genou droit",       cx: 91,   cy: 138, rx: 8,  ry: 6  },
  { id: "knee_l_b",   label: "Genou gauche",      cx: 115,  cy: 138, rx: 8,  ry: 6  },
  { id: "calf_r",     label: "Mollet droit",      cx: 90,   cy: 158, rx: 7,  ry: 11 },
  { id: "calf_l",     label: "Mollet gauche",     cx: 116,  cy: 158, rx: 7,  ry: 11 },
  { id: "ankle_r_b",  label: "Cheville droite",   cx: 89,   cy: 176, rx: 6,  ry: 4  },
  { id: "ankle_l_b",  label: "Cheville gauche",   cx: 117,  cy: 176, rx: 6,  ry: 4  },
  { id: "heel_r",     label: "Talon droit",       cx: 88,   cy: 189, rx: 8,  ry: 5  },
  { id: "heel_l",     label: "Talon gauche",      cx: 118,  cy: 189, rx: 8,  ry: 5  },
];
...
export default function BodyMap({ onComplete }) {
  ...
  const [debug, setDebug]       = useState(false); // toggle to see zones
    ...
    <div style={{ fontFamily: "'Georgia','Times New Roman',serif", maxWidth: 440, margin: "0 auto", padding: "0 12px 20px" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 8 }}>
        <button onClick={() => setDebug(d => !d)} style={{
          ...
          fontFamily: "inherit", border: "1px solid rgba(74,159,212,0.4)",
          background: debug ? "#e8f4f8" : "transparent", color: "#4a9fd4",
        }}>
          {debug ? "🔍 Zones visibles" : "🔍 Afficher les zones"}
        </button>
      </div>
      ...
      <div style={{ position: "relative", background: "white", borderRadius: 20, padding: "12px 8px", boxShadow: "0 4px 20px rgba(45,123,170,0.12)", marginBottom: 12 }}>
        <svg viewBox="0 0 206.326 206.326" style={{ width: "100%", maxHeight: 440, display: "block", margin: "0 auto" }}>
          ...
          {/* Zone outlines — always visible in debug, dashed on hover otherwise */}
          {zones.map(z => {
            ...
            return (
              <g key={z.id}>
                <ellipse
                  ...
                  stroke={
                    debug ? "rgba(74,159,212,0.5)" :
                    isSelected ? "#2d7baa" :
                    isPainted ? "transparent" : "transparent"
                  }
                  strokeWidth={debug ? "0.8" : "1.2"}
                  strokeDasharray={debug ? "2,1.5" : isSelected ? "3,2" : "0"}
                  style={{ cursor: "pointer" }}
                  onClick={() => setSelected(isSelected ? null : z.id)}
                />
                {/* Zone label in debug mode */}
                {debug && (
